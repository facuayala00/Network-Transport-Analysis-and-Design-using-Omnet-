...
{
    this->fullBufferQueue = other.fullBufferQueue;
    this->fullBufferR = other.fullBufferR;
}

void FeedbackPkt::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->fullBufferQueue);
    doParsimPacking(b,this->fullBufferR);
}

void FeedbackPkt::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->fullBufferQueue);
    doParsimUnpacking(b,this->fullBufferR);
}

bool FeedbackPkt::getFullBufferQueue() const
{
    return this->fullBufferQueue;
}

void FeedbackPkt::setFullBufferQueue(bool fullBufferQueue)
{
    this->fullBufferQueue = fullBufferQueue;
}

bool FeedbackPkt::getFullBufferR() const
{
    return this->fullBufferR;
}

void FeedbackPkt::setFullBufferR(bool fullBufferR)
{
    this->fullBufferR = fullBufferR;
}
...
unsigned int FeedbackPktDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_fullBufferQueue
        FD_ISEDITABLE,    // FIELD_fullBufferR
    };
...
int FeedbackPktDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "fullBufferQueue") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "fullBufferR") == 0) return baseIndex + 1;
...
const char *FeedbackPktDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "bool",    // FIELD_fullBufferQueue
        "bool",    // FIELD_fullBufferR
    };
...
std::string FeedbackPktDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_fullBufferQueue: return bool2string(pp->getFullBufferQueue());
        case FIELD_fullBufferR: return bool2string(pp->getFullBufferR());
        default: return "";
    }
}
...
void FeedbackPktDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_fullBufferQueue: pp->setFullBufferQueue(string2bool(value)); break;
        case FIELD_fullBufferR: pp->setFullBufferR(string2bool(value)); break;
...
omnetpp::cValue FeedbackPktDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_fullBufferQueue: return pp->getFullBufferQueue();
        case FIELD_fullBufferR: return pp->getFullBufferR();
...
void FeedbackPktDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    FeedbackPkt *pp = omnetpp::fromAnyPtr<FeedbackPkt>(object); (void)pp;
    switch (field) {
        case FIELD_fullBufferQueue: pp->setFullBufferQueue(value.boolValue()); break;
        case FIELD_fullBufferR: pp->setFullBufferR(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FeedbackPkt'", field);
    }
}
